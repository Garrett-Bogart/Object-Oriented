...
public class EllipseTest {
    ...
    public void testValidConstruction() throws Exception {
        ...
        assertEquals(1, ellipse.getCenter().getX(), 0);
        assertEquals(2, ellipse.getCenter().getY(), 0);
        assertEquals(3, ellipse.getRadius(), 0);
        assertEquals(5, ellipse.getRadius2(), 0);
        
        ellipse = new Ellipse(17.3, 6.66, 9.13, 4.20);
        assertEquals(17.3, ellipse.getCenter().getX(), 0);
        assertEquals(6.66, ellipse.getCenter().getY(), 0);
 ...
 //*************Ellipse**********       
	...
	public void testMove() throws ShapeException {
        ...
        ellipse.move(3,  4);
        assertEquals(4, ellipse.getCenter().getX(), 0);
        assertEquals(6, ellipse.getCenter().getY(), 0);
        assertEquals(5, ellipse.getRadius(), 0);

        ellipse.move(0.123,  0.456);
        assertEquals(4.123, ellipse.getCenter().getX(), 0);
        assertEquals(6.456, ellipse.getCenter().getY(), 0);
        assertEquals(5, ellipse.getRadius(), 0);
        ...
        ellipse.move(-12,  -26);
        assertEquals(-8, ellipse.getCenter().getX(), 0);
        assertEquals(-20, ellipse.getCenter().getY(), 0);
        assertEquals(5, ellipse.getRadius(), 0);
