...
import shapes.*;import org.junit.Test;
...
public class TestShapeFactory {
	@Test
	public void testMakeShape() throws NumberFormatException, ShapeException, IOException
	{
	...
	@Test
	public void testMakeComposite() throws NumberFormatException, ShapeException, IOException
	{
		ShapeFactory sf = new ShapeFactory();
		Shape shape;
		Composite comp;
